...
class ReportDataSnapshot(models.Model):
    ...
    health_confirmed_cases = models.FloatField(null=True, blank=True, help_text="HDX sitrep — latest cumulative confirmed cases in window")
    health_suspected_cases = models.FloatField(null=True, blank=True, help_text="HDX sitrep — latest cumulative suspected cases in window")
    health_deaths = models.FloatField(null=True, blank=True, help_text="HDX sitrep — latest cumulative deaths in window")
    health_alert_score = models.FloatField(null=True, blank=True, help_text="Normalised 0-100 — informational only, NOT included in composite_score")
    health_data_as_of = models.DateField(null=True, blank=True, help_text="Reference date of the HDX figures used")
